...
router.delete("/api/categoria/:id",categoriasController.delete);
...
router.delete("/api/lancamento/:id",receitaController.delete);
...
router.delete("/api/objetivo/:id",objetivoController.delete);
...
router.delete("/api/conta/:id",contaController.delete);
