        ...
        <><div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                <div class="grid grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                        <div class="gap-4 mb-4 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700 cursor-pointer" onClick={() => propsPost.setOpenModalPost('initial-focus')}>
                        ...
                        {
                            //"Adiciona em baixo da nova conta"
                        }
                    </div>

                    <div>
                        <div class="gap-4 mb-4 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700">
                            <div className='flex justify-end px-4 pt-4 group'>
                                ...
                                >
                                    ...
                                    <Modal.Body>
                                        <div className="space-y-6">
                                            <h3 className="text-xl font-medium text-gray-900 dark:text-white">Editar Carteira</h3>
                                            <div>
                                                <div className="mb-2 block">
                                                    <Label
                                                        value="Nome da Categoria"
                    ...
                    */}
                    <div></div>
                    <div class="grid grid-rows-2 gap-4 mb-4 h-40">
                        <div class="flex flex-col items-center justify-center w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700">
                            <div className='grid grid-cols-2'>
                                <span class="text-l font-bold leading-tight text-gray-500 dark:text-gray-400">Saldo atual</span>
                                <span class="ml-16 text-l font-bold leading-tight text-gray-500 dark:text-gray-400">R$ 00,00</span>
                            </div>
                        ...
                        <div class="flex flex-col items-center justify-center w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700">
                            <div className='grid grid-cols-2'>
                                <span class="text-l font-bold leading-tight text-gray-500 dark:text-gray-400">Saldo previsto</span>
                                <span class="ml-16 text-l font-bold leading-tight text-gray-500 dark:text-gray-400">R$ 00,00</span>
                            </div>
                        </div>
                    </div>
